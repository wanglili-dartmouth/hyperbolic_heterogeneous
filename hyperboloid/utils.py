...
def determine_positive_and_negative_samples(graph, walks,args):
	...
	def determine_positive_samples_and_probs(graph, walks,args):
	...
	positive_samples, probs = determine_positive_samples_and_probs(graph, walks,args)
